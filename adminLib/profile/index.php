...
<body oncontextmenu="return false" class="prevent-select">
        ...
        <div class="col-xl-12 col-md-12 col-sm-12 mx-auto ">
            ...
            <div class="bg-white shadow rounded overflow-hidden">
                <div class="px-4 pt-5 pb-5 bg-dark profile-cover">
                    <div class="media align-items-end profile-header" style="margin-bottom: 5rem;">
    ...
    <div class="row bio">
        ...
        <div class="col-xl-6 col-md-9 col-sm-12 mx-auto">
            ...
            <?php echo '<div class="text-bg-light shadow p-3 mb-5 bg-body rounded">' . $_SESSION['bio'] . '</div>'; ?>
