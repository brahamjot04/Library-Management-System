        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.gndpoly.org/library.php?library=home" target="_blank">Library</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="https://library.gndpoly.org/dig_lib/home/" target="_blank">Digital Library</a>
                    </li>
                    ...
                    <?php } else { ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../mgmLib/">Manage Library</a>
                        </li>
