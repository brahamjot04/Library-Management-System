    ...
    */
    ...
    if (empty($username) || empty($password)) {
        ...
        */
        ...
        $sql = "UPDATE admin_users SET last_login_at=NOW() WHERE username=?;";
                ...
                if ($pwdCheck == false) {
                    ...
                    */
                    ...
                    if (isset($_POST['rememberme'])) {
                        ...
                        $sql = "DELETE FROM admin_auth_tokens WHERE user_email=? AND auth_type='remember_me';";
                        $stmt = mysqli_stmt_init($conn);
                        if (!mysqli_stmt_prepare($stmt, $sql)) {
                        ...
                        $sql = "INSERT INTO admin_auth_tokens (user_email, auth_type, selector, token, expires_at) 
                                VALUES (?, 'remember_me', ?, ?, ?);";
                        $stmt = mysqli_stmt_init($conn);
                        if (!mysqli_stmt_prepare($stmt, $sql)) {
