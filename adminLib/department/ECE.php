...
<div class="container-fluid my-4">
    <h6 class="h2 mb-3 font-weight-normal text-muted text-center">View Books<br>(Electronics & Communication Engineering Department)
    </h6>
</div>
<div class="container">
...
<div class="container mt-5 d-grid">
    <?php
    // Search Query
    $query = "SELECT * FROM admin_books WHERE Dept_name='ECE'";
