...
define('TITLE', "Computer Science & Engg.");
...
<div class="container-fluid my-4">
    <h6 class="h2 mb-3 font-weight-normal text-muted text-center">View Books<br>(Computer Science & Engineering Department)
    </h6>
</div>
<div class="container">
...
<div class="container mt-5 d-grid">
    <?php
    // Search Query
    $query = "SELECT * FROM admin_books WHERE Dept_name='CSE'";
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Computer Science & Engineering</h5>
