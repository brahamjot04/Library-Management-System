...
<script type="text/javascript" src="scriptLiterature.js"></script>
<!-- Custom JS File End -->
...
<div class="container-fluid" style="margin-top:100px;">
    <h6 class="h2 mb-3 font-weight-normal text-muted text-center">View Books<br>(Literature)
    </h6>
</div>
<div class="container">
...
<div class="container mt-5 d-grid">
    <?php
    // Search Query
    $query = "SELECT * FROM admin_books WHERE Dept_name='Literature'";
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Literature</h5>
