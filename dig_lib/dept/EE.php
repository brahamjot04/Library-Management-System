...
<title>Electrical Engg. | Digital Library</title>
...
<script type="text/javascript" src="scriptEE.js"></script>
<!-- Custom JS File End -->


<!-- Main Heading Block -->
<div class="container" style="margin-top:100px;">
    <h6 class="h2 mb-3 font-weight-bold text-dark text-center">Electrical Engg. Books</h6>
</div>
...
<div class="container rounded shadow border mb-5" style="background-color:#fff;">
    ...
    <div class="container d-grid">
        ...
        <?php
        // Search Query
        $qry0 = "SELECT * FROM admin_books WHERE Dept_name='EE'";
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mt-2">
            <div class="container">
                ...
                embed-responsive embed-responsive-16by9" style="min-width:280px; min-height:157px;" width="560px" height="200px" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" src="https://www.youtube.com/embed/videoseries?list=PLgzsL8klq6DKyjPkOSOynMO3K_zIusq48" allowfullscreen></iframe>
                <p class="pl-4 mt-2">Electrical Machines</p>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mt-2">
            <div class="container">
                <iframe class="tutorial container text-center mt-5
                embed-responsive embed-responsive-16by9" style="min-width:280px; min-height:157px;" width="560px" height="200px" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" src="https://www.youtube.com/embed/videoseries?list=PLgzsL8klq6DLcJrFzyhLBm48mObP0xmuA" allowfullscreen></iframe>
                <p class="pl-4 mt-2">Power Electronics</p>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mt-2">
            <div class="container">
                <iframe class="tutorial container text-center mt-5
                embed-responsive embed-responsive-16by9" style="min-width:280px; min-height:157px;" width="560px" height="200px" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" src="https://www.youtube.com/embed/i2XlIjCjUqY" allowfullscreen></iframe>
                <p class="pl-4 mt-2">Fundamental of Electrical Energy</p>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-2">
            <div class="container">
                ...
                embed-responsive embed-responsive-16by9" style="min-width:280px; min-height:157px;" width="560px" height="200px" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" src="https://www.youtube.com/embed/videoseries?list=PLk7ptZcI9vmgF6T_JnDtzOoNpAG4WS8_H" allowfullscreen></iframe>
                <p class="pl-4 mt-2">Estimation & Costing in Electrical Engg.</p>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-2">
            <div class="container">
                <iframe class="tutorial container text-center mt-2
                embed-responsive embed-responsive-16by9" style="min-width:280px; min-height:157px;" width="560px" height="200px" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" src="https://www.youtube.com/embed/videoseries?list=PLm_MSClsnwm9S8ZZEi1PUt0W1ISIj4eGJ" allowfullscreen></iframe>
                <p class="pl-4 mt-2">Industrial Electronics</p>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-2">
            <div class="container">
                <iframe class="tutorial container text-center mt-2
                embed-responsive embed-responsive-16by9" style="min-width:280px; min-height:157px;" width="560px" height="200px" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" src="https://www.youtube.com/embed/gKvq0ECLUpk" allowfullscreen></iframe>
                <p class="pl-4 mt-2">Conventional & Non Conventional Energy source</p>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Electrical Engineering</h5>
