...
(31, 'brahamjot2004', 'brahmjot23@gndpoly.org', 'UPDATE `admin_users` SET `password` = `$2y$10$TbLnQHbLOTel/Vl59wxVluoCiH6Y1fvUh0y1u.DR5p8TclP7u4ANG`, `deleted_at` = NULL WHERE `admin_users`.`id` = 31;', 'Brahamjot', 'Singh', 'm', 'Test', 'Test', '637a7cd9a13572.23393843.jpg', '2022-11-20 16:35:20', '2022-11-20 16:27:46', '2023-05-08 08:19:14', NULL, '2023-05-08 08:19:14'),
