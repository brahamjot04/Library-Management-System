    ...
    */
    ...
    if (empty($username) || empty($password)) {
        ...
        */
        ...
        $sql = "UPDATE stu_users SET last_login_at=NOW() WHERE username=?;";
        ...
        */
        ...
        $sql = "SELECT * FROM stu_users WHERE username=?;";
        $stmt = mysqli_stmt_init($conn);
                ...
                if ($pwdCheck == false) {
                    ...
                    */
                    ...
                    if (isset($_POST['rememberme'])) {
                        ...
                        $sql = "DELETE FROM stu_auth_tokens WHERE user_email=? AND auth_type='remember_me';";
                        $stmt = mysqli_stmt_init($conn);
                        if (!mysqli_stmt_prepare($stmt, $sql)) {
